...
class TempSectors(Widget):
    ...
    def __init__(self, **kwargs):
        ...
        self.valuelabel = SectorLabel(text =str(self.sectorvalue)+self.measure , bgclr = [1,1,1,0],lineclr=[1,1,1,1],color = [0.1,1,0.20,1], font_size = '16sp')
    ...
    def _upgrade(self,*args):
        self.valuelabel.text = str(self.sectorvalue)+str(self.measure)
