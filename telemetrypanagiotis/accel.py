...
class Accel(Widget):
    ...
    path = os.getcwd()
    file_backgnd = StringProperty(join(path, "/home/panos/telemetry/images/scope.xcf" ))
    file_point = StringProperty(join(path, "/home/panos/telemetry/images/point_gg.xcf" ))
    ...
    def _turn(self, *args):
        self._img_point.center=(self.center_x+(self.value[0]/55),self.center_y+(self.value[1]/55))
        # self._img_point.center = (self.center_x+self.value[0]/1000,self.center_y+self.value[1]/1000)
        self._glab.text = "Lat: "+str(round((self.value[0]/1000),1))+"/ Long: "+str(round((self.value[1]/1000),1))
