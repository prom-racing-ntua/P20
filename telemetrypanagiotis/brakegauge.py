...
class BrakeGauge (Widget):
    ...
    def __init__(self,**kwargs):
        ...
        self.label_val=Label(text = '0 %',font_size='10sp')
        self.brakelabel=Label(text = 'BRAKE',font_size='10sp')
        self.add_widget(self.label_val)
    ...
    def _update(self,*args):
        ...
        self.label_val.center= self.center_x+15,self.top+10

    def _upgrade(self, *args):
        self.ids.brakepb.value = self.brakevalue
        self.label_val.text = str(int(self.brakevalue))+" %"
