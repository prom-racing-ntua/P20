...
class Main(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        self.motor_temp = Icon_Indicator(pos_hint={"x": 0.3, "y": 0.35}, size_hint=(0.1, 0.1), name="Motor Temp", value=0, unit="°C", boundaries=[int(cfgs['motor_temp_warn']), int(cfgs['motor_temp_crit'])], source="assets/gear.png", color=[1, 1, 1], opacity=0.7)
        ...
        self.steering_wheel = Icon_Indicator(pos_hint={"x": 0.7, "y": 0.665}, size_hint=(0.08, 0.08), name="Steering Angle", value=0, unit="°" , boundaries=[100,120], source="assets/steering_wheel2.png", color=[0.8,0.8,0.8,1], angle=0, opacity=1)
        ...
        Clock.schedule_interval(self.dash_test, 2)
    ...
    def dash_test(self, dt):
        self.dashboard.status = random.randint(0,255)
